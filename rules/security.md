...
- Keep memory artifacts (`.moonshot-relay/memorygraph/`, `.moonshot-relay/legacy/claude/memory.json`) free of sensitive data.
- Treat `.env*`, key/cert files, `.history/`, `.tmp/`, `.moonshot-relay/`, `.claude/logs/`, `.claude/memory.json`, and `.claude/memorygraph/` as protected paths.
