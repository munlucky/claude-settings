...
const hardFloorSurfaces=new Set(['securityBoundary','dataMigration','publicContract','schemaChange','runtimeAuthority']);
export const selectProofTier=(task={})=>{
  ...
  if((task.surfaces||[]).some((s)=>hardFloorSurfaces.has(s))) tier='T3';
  return tier;
};
