...
When adding a new skill, agent, rule, script, schema, template, or test:

1. Edit the matching canonical root directory first, such as `skills/`, `agents/`, `rules/`, `scripts/`, `schemas/`, `templates/`, or `tests/`.
