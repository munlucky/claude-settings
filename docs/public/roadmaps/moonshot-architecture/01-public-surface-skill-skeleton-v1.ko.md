...
- 필수 문서:
  - `docs/public/roadmaps/moonshot-architecture/00-master-plan-v1.ko.md`
  - `package/runtime-surface.json`
  - `package/package-contract.yaml`
...
- Verification evidence path: `docs/public/roadmaps/moonshot-architecture/execution/phase-01/QA_REPORT.md`
