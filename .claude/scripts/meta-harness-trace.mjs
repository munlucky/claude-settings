...
function captureTrace(options) {
  ...
  const manifest = {
    ...
    workflow: {
      ...
      selectedModelProvider: workflowState?.selectedModelProvider ?? analysis?.workflowEvidence?.selectedModelProvider ?? '',
      selectedModel: workflowState?.selectedModel ?? analysis?.workflowEvidence?.selectedModel ?? '',
      selectedModelEffort: workflowState?.selectedModelEffort ?? analysis?.workflowEvidence?.selectedModelEffort ?? '',
      modelSelectionReason: workflowState?.modelSelectionReason ?? analysis?.workflowEvidence?.modelSelectionReason ?? '',
