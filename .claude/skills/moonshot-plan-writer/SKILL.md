...
5. Run independent review loops as sidecar review, then parent applies accepted edits.
6. Prepare execution only after readiness, traceability, and phase boundary checks are satisfied.
