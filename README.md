...
- source-owned 장기 roadmap은 `docs/public/roadmaps/`에 추적하고, phase 실행 중 생성되는 runtime execution scratch는 `docs/implementation/**`에 두되 배포/설치 payload에는 포함하지 않음
...
- runtime execution scratch 루트: `docs/implementation/**` (generated phase-runner readiness, attempt, QA, scorecard, handoff, and other execution artifacts; not tracked)
