...
node "$ROOT_DIR/.claude/scripts/verification-verdict-state.mjs" self-test > "$TMP_ROOT/verification-verdict-state-self-test.out"
assert_contains "$TMP_ROOT/verification-verdict-state-self-test.out" "verification-verdict-state self-test passed" "verification verdict state self-test"
node "$ROOT_DIR/.claude/scripts/lib/lifecycle-projection-writer.mjs" self-test > "$TMP_ROOT/lifecycle-projection-writer-self-test.out"
assert_contains "$TMP_ROOT/lifecycle-projection-writer-self-test.out" "lifecycle-projection-writer self-test passed" "lifecycle projection writer self-test"
